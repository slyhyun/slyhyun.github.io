        ...
        <div style="display: flex; justify-content: center; align-items: center; gap: 50px;">
          ...
          <div style="text-align: left; max-width: 500px;">
            ...
            <p style="font-size: 100%;color: white; margin-top: 20px;">
              ...
              <a href="{{ .Site.BaseURL }}uploads/document.pdf" style="background-color: #946efd; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; font-size: 100%;">Recent Written Document</a>
